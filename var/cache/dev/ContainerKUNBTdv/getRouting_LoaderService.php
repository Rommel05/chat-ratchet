...
class getRouting_LoaderService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a->addLoader(new \EasyCorp\Bundle\EasyAdminBundle\Router\AdminRouteLoader(($container->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Router\\AdminRouteGenerator'] ?? $container->getAdminRouteGeneratorService())));
        $a->addLoader($c);
