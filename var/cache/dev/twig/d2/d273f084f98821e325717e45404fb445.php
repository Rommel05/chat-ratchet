...
class __TwigTemplate_0050217c8558ea220aa68dd77b3ee2d8 extends Template
{
...
";
    ...
    public function block_body(array $context, array $blocks = []): iterable
    {
        ...
        // line 13
        yield "    <div id=\"content\" class=\"d-flex justify-content-center align-items-center\" style=\"height: 100vh;\">
        <div class=\"login-container p-4 rounded shadow-lg bg-white\">
            <header class=\"mb-4\">
        ...
        yield "\" method=\"post\" id=\"form\">
                    <div class=\"mb-3\">
                        <label for=\"username\" class=\"texto form-label\">Email</label>
        ...
        yield "\" class=\"form-control\" required>
                    ...
                    <div class=\"mb-3\">
                        <label for=\"password\" class=\"texto form-label\">Password</label>
                        <input type=\"password\" id=\"password\" name=\"_password\" class=\"form-control\" required>
                    </div>

                    <button type=\"submit\" id=\"boton\" class=\"btn btn-lg w-100\">Login</button>
                </form>
            </main>
        </div>
    </div>
";
    ...
    {
        return array (  149 => 23,  143 => 20,  134 => 13,  121 => 12,  108 => 9,  103 => 8,  90 => 7,  78 => 4,  65 => 3,  42 => 1,);
    }
...
{% block body %}
    <div id=\"content\" class=\"d-flex justify-content-center align-items-center\" style=\"height: 100vh;\">
        <div class=\"login-container p-4 rounded shadow-lg bg-white\">
            <header class=\"mb-4\">
                <h1 class=\"display-4 text-center\">Login</h1>
            </header>
